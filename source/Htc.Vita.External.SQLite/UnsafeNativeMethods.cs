...
namespace Htc.Vita.External.SQLite
{
  ...
  {
      private const string NativeApiVersion = "0.9.0.8";
      ...
      {
          Sha1ChecksumWithVersion.Add("6d8b934b1dcc323e62a53625bf564d3dfe65cfd2", "0.9.0.8 ( win32 / x86 )");
          Sha1ChecksumWithVersion.Add("241c26b0d5d934c9d50150bf741f5cc21edc3c29", "0.9.0.8 ( win32 / x64 )");
      }
